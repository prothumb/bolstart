...
class PostsController extends Controller
{
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id', 'name', 'category_name', 'type', 'status', 'updated_at', 'published_at', 'is_featured');
    ...
    public function store(PostsRequest $request)
    {
        ...
        $data['event_category'] = $request->input('event_category');
        $data['event_date'] = $request->input('event_date');
        $data['rsvp_link'] = $request->input('rsvp_link');
        $data['linkedin_link'] = $request->input('linkedin_link');
