            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    <button class="btn btn-info" type="button" id="button-image" \
                       data-input="{{$field_name}}"><i class="fas fa-folder-open"></i> @lang('Browse')</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-12" id="eventFields" style="display: none;">
    <input type="text" class="form-control" name="event_category" placeholder="Event Category" style="width:60%" 
            value="{{$$module_name_singular->event_category}}"/><br/>

    <input type="date" class="form-control" name="event_date" placeholder="Event Date" style="width:60%" 
        value="{{$$module_name_singular->event_date}}"/><br/>


    <input type="text" class="form-control" name="rsvp_link" placeholder="RSVP Link" style="width:60%" 
        value="{{$$module_name_singular->rsvp_link}}"/><br/>


    <input type="text" class="form-control" name="linkedin_link" placeholder="LinkedIn Link" style="width:60%" 
        value="{{$$module_name_singular->linkedin_link}}"/><br/>


    <input type="text" class="form-control" name="instagram_link" placeholder="Instagram Link" style="width:60%" 
        value="{{$$module_name_singular->instagram_link}}"/><br/>


    <input type="text" class="form-control" name="twitter_link" placeholder="Twitter Link" style="width:60%" 
        value="{{$$module_name_singular->twitter_link}}"/><br/>
</div>
...
<script>
    ...
    $(document).ready(function() {
    // Function to show/hide event fields based on type value
    function toggleEventFields() {
        var selectedOption = $('#type').val();
        if (selectedOption === 'Feature' || selectedOption === 'Event') {
            $('#eventFields').show();
        } else {
            $('#eventFields').hide();
        }
    ...
    // Trigger the function when the type field value changes
