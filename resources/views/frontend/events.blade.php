...
@section('title') Bolstart - Events @endsection
...
<style>
	...
	.jkit-button-wrapper{
    	...
    	line-height: 1em;
    	letter-spacing: var(--e-global-typography-acdd552-letter-spacing);
    	word-spacing: var(--e-global-typography-acdd552-word-spacing);
    	color: #FFFFFF;
...
<div data-elementor-type="wp-page" data-elementor-id="980" class="elementor elementor-980">
	...
	<section class="recent-news-section elementor-section elementor-inner-section elementor-element elementor-element-5d34261 
		...
		<div class="elementor-container elementor-column-gap-no" 
			style="display:flex;flex-direction:row;justify-content:space-between;align-items:flex-start;width:100%;flex-wrap:wrap">	

		@foreach($events as $event)						

		
			<div class="elementor-column elementor-col-25 blogs-grid-col elementor-inner-column elementor-element elementor-element-abc6796" data-id="abc6796" data-element_type="column">
				...
				<div class="elementor-widget-wrap elementor-element-populated">
					...
					<div class="elementor-element elementor-element-b2db7c8 elementor-widget elementor-widget-jkit_post_block" 
						...
						<div class="elementor-widget-container">
							...
							<div class="jeg-elementor-kit jkit-postblock postblock-type-2 jkit-pagination-disable 
								post-element jeg_module_980_3_653f6d2534f01"  data-id="jeg_module_980_3_653f6d2534f01"
								...
								<div class="jkit-block-container">
									<div class="jkit-posts jkit-ajax-flag">
										...
										<article class="jkit-post post-716 post type-post status-publish 
											format-standard has-post-thumbnail hentry category-business tag-business">
                    
											<div class="jkit-thumb" style="">
												<a href="{{ route('frontend.single.event', ['id' => $event->slug]) }}">

													<div class="thumbnail-container small-thumbnail" style="border-radius: 10px 10px 0 0;">
                							...
                							<div class="jkit-postblock-content" style="border-width:1px 1px 1px 1px;border-bottom-color:#DEE2E7;
													border-left-color:#DEE2E7;
													border-right-color:#DEE2E7;box-shadow:0px 0px 0px 0px rgba(107, 137.00000000000006, 180, 0.15);
													padding:8px;border-top-color:transparent">
												...
												<div class="elementor-widget-container">
													<div class="elementor-icon-wrapper" style="display:flex;flex-direction:row;align-items:center">
														...
														<div class="jeg-elementor-kit jkit-post-author jeg_module_715_3_654f64e45209e">
																<p class="post-author" style="font-size:13px !important;font-weight:400;color:#000;margin-left:0px">
												...
												<p style="font-family:Mulish">{{$event->intro}}</p>
												
					
												<div class="jkit-post-meta" style="display:flex;flex-direction:column;margin-top:10px !important">
												...
												<a href="{{ $event->rsvp_link }}" 
													class="jkit-button-wrapper" style="font-family:Mulish;display:block;width:50%;margin-top:20px">RSVP Here</a>
