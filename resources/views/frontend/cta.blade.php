								...
								<div class="elementor-widget-container">
									<div
										...
										<div class="heading-section-title  display-inline-block">
											<h2 class="heading-title home-main-heading-title">Don’t need Crores to <span class="style-color home-main-heading-title" style="display:inline">
											<span style="position: relative; display: inline-flex; flex-direction: column; align-items: center; margin: 0 10px;">
      <span style="content: ''; position: absolute; top: -25px; width: 176px; height: 116px; background: url('img/green-circle.png') no-repeat center/contain;"></span>
      <span style="content: ''; position: absolute; border: 2px solid #11ee84; border-radius: 50%; width: 50px; height: 50px; top: -15px; left: 5px; z-index: -1;"></span>
											Invest</span></span>
											in startups!</h2>
										</div>
									</div>
							...
							<div class="elementor-element elementor-element-1649c294 elementor-widget__width-initial elementor-widget elementor-widget-text-editor"
								...
								Do you know many startups raise funding through small cheque sizes. Want to learn <span style="display:inline;color: rgb(17, 238, 132); height: 36px;">
								How?</span>
								</div>
							</div>
...
<!-- 
    ...
    <iframe 
		...
		width="100%"
        height="500" 
        src="https://www.youtube.com/embed/LH9vTMDy5PY?si=YyGaekvhBYG4GH6l" 
...
<section class="webinar-registration-bg" id="webinar-registration-scroll">
  <div class="webinar-registration">
    ...
    <div class="webinar-schedule">
      ...
      <p>Join our exclusive close-group webinar to discover something extraordinary!</p>
 ...
 -->
		...
		<!-- Link to Google Fonts or custom stylesheet for Publica Sans -->
<link href="https://fonts.googleapis.com/css2?family=Publica+Sans:wght@400&display=swap" rel="stylesheet">

<section class= "card-module">
    <!-- <h2>Why Should You <span>Join</span> Webinar?</h2> -->
	<h2 style="font-family: 'Poppins', sans-serif; font-size: 48px">
    Why Should You 
    <span style="position: relative; display: inline-flex; flex-direction: column; align-items: center; margin: 0 5px;">
      <span style="content: ''; position: absolute; top: -25px; width: 106px; height: 106px; background: url('img/green-circle.png') no-repeat center/contain;"></span>
      <span style="content: ''; position: absolute; border: 2px solid #11ee84; border-radius: 50%; width: 50px; height: 50px; top: -15px; left: 5px; z-index: -1;"></span>
      Join
    </span> 
    Webinar?
    ...
    <p>This webinar is for people to learn about investing in startups with small cheque sizes. In this, you'll learn:</p>
    <div class="card-container">
      <!-- Card 1 -->
      <div class="card">
        <div class="card-inner">
          <div class="card-image">
            <img src="img/card-1.png" alt="Mindset of Successful Angel Investors">
          </div>
          <p class="card-caption">Understand the mindset of successful Angel Investors</p>
        </div>
      </div>
      <!-- Card 2 -->
      <div class="card">
        <div class="card-inner">
          <div class="card-image">
            <img src="img/card-2.png" alt="How to invest in Startups & Case Studies">
          </div>
          <p class="card-caption">How to invest in Startups & some Case studies</p>
        </div>
      </div>
      <!-- Card 3 -->
      <div class="card">
        <div class="card-inner">
          <div class="card-image">
            <img src="img/card-3.png" alt="Legalities & Successful Exit Strategies">
          </div>
          <p class="card-caption">Legalities & successful Exit Strategy from startups</p>
        </div>
      </div>
    </div>
  </section>
...
<section class="join-network">
  <h1 style="font-size: 3.5rem; margin-bottom: 20px; font-family: 'Poppins', sans-serif;">
    Join <span style="color: #11ee84;">Bolstart</span> Network
  </h1>
  <div style="display: flex; justify-content: center; gap: 75px; flex-wrap: wrap; margin-bottom: 40px;">
    <div>
      <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: 5rem; color: #11ee84; margin-bottom: 10px;
	  padding: 20px;">700+</h2>
      <p style="font-size: 2.5rem; font-family: 'Poppins', sans-serif;">Investors</p>
    </div>
    <div>
      <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800;  font-size: 5rem; color: #11ee84; margin-bottom: 10px;
	  padding: 20px;">500+</h2>
      <p style="font-size: 2.5rem; font-family: 'Poppins', sans-serif;">Startups</p>
    </div>
    <div>
      <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: 5rem; color: #11ee84; margin-bottom: 10px;
  ...
  <button style="font-family: 'Poppins', sans-serif; background: linear-gradient(90deg, #00ff99, #005a43);; color: white; border: none; border-radius: 5px; padding: 10px 20px; font-size: 2rem; cursor: pointer;">
    Join Minds From
  </button>
	<div class= "container">
  <div style="margin-top: 20px; display: flex; justify-content: center; gap: 30px; flex-wrap: wrap;">
    <img src="img/capgemini-logo.png" alt="Capgemini" style="height: 60px;">
    <img src="img/harvard-logo.png" alt="Harvard Business School" style="height: 60px;">
    <img src="img/bcg-logo.png" alt="BCG" style="height: 60px;">
    <img src="img/cummins-logo.png" alt="Cummins" style="height: 60px;">
    <img src="img/jpmorgan-logo.png" alt="JPMorgan Chase" style="height: 60px;">
...
<section class="questions-banner">
  ...
  <a href="https://www.facebook.com/bolstart" target="_blank" title="Facebook">
    <i class="fab fa-facebook-f"></i>
  </a>
  <a href="https://x.com/bolstart" target="_blank" title="X">
    <i class="fab fa-x-twitter"></i>
  </a>
  <a href="https://www.linkedin.com/company/bolstart" target="_blank" title="LinkedIn">
    <i class="fab fa-linkedin-in"></i>
  </a>
  <a href="https://www.youtube.com/@bolstart" target="_blank" title="YouTube">
    <i class="fab fa-youtube"></i>
  </a>
  <a href="https://www.instagram.com/bolstart_" target="_blank" title="Instagram">
    <i class="fab fa-instagram"></i>
  </a>
  <a href="https://t.me/investinstartupsbolstart" target="_blank" title="Telegram">
	...
	<img src="img/team-meeting.png" alt="Team Meeting">
	
	<a href="https://wa.me/" target = "_blank" class="whatsapp-btn">LEARN MORE</a>
    </div>
  </div>
...
.webinar-registration-bg {
  background-image: url('img/background-gradient.png') !important;
...
.green-circle {
  ...
  width: 176px;
  height: 116px;
  background: url('img/green-circle.png') no-repeat center/contain;
}

.inner-circle {
  position: absolute;
  border: 2px solid #11ee84;
  border-radius: 50%;
  width: 50px;
  height: 50px;
  top: -15px;
...
@media (max-width: 768px) {
  ...
  @media (max-width: 768px) {
	...
	.banner-right {
      display: none !important; /* Hides the right banner */
    }
...
.join-network{
	background-image: url('img/background-gradient.png') !important; /* Replace with your image URL */
    background-size: cover !important;  /* Ensures the image covers the entire section */
    background-position: 0 !important;  /* Centers the image */
...
.card-image {
  width: 100%;
  height: 420px;  /* Matches the total card height minus caption height */
  overflow: hidden;
  margin: 0 auto;
}
...
.card-caption {
  font-size: 1.5rem;
  margin-top: 0px; /* Minimal gap between image and caption */
...
.container {
  ...
  box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.05); /* Shadow similar to the image */
  display: flex;
  align-items: center;
  justify-content: center;
...
.logo {
  ...
  max-width: 150px; /* Prevent logos from stretching too wide */
  object-fit: contain; /* Ensure logos maintain proportions */
}
  ...
  .social-icons a {
    ...
    width: 50px;
    height: 50px;
    background-color: #1d2437; /* Background color for icons */
    color: white; /* Icon color */
    font-size: 24px; /* Icon size */
    font-weight: bold; /* Font weight for symbols */
  ...
  .social-icons a:hover {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.5); /* Darker shadow on hover */
  }

 .investors-section{

	background-image: url('img/background-gradient.png'); /* Replace with your image URL */
  ...
  .questions-banner {
    background-image: url('img/background-gradient.png')!important;/* Add the image path here */
	background-size: cover !important;  /* Ensures the image covers the entire section */
    background-position: 0 !important;  /* Centers the image */
    background-repeat: no-repeat;  /* Prevents the image from repeating */
...
.register-btn {
    ...
    padding: 20px 30px;
    border: none;
    border-radius: 35px; /* Adjusted for a more rounded rectangle */
